...
import { team, game, homeX, homeY, base1X, base1Y, base2X, base2Y, base3X, base3Y } from "../../constants";
...
export default function Action() {
  ...
  return (
    ...
    <div className='svg-container' onClick={handleClick} ref={svgContainerRef}>
      ...
      <p className="player-overlay-home">{team.players[team.turn].name} | {team.players[team.turn].number}</p>
      {click && (
